							...
							<div class="row no-gutters">
								...
								<div class="col-md-4">
									<div class="card-body">
										<br>
										<br>
										<h5 class="card-title">품종 : 스피츠</h5>
										<p class="card-text">이름 : 강아지</p>
										<p class="card-text">분양코드 : 000000</p>
									</div>
								</div>
							</div>
						</div>
					...
					<td width=810px><br>
						...
						<table align="center">
							<tr>
								<td width="800px">
									<div class="row">
										<div class="input-group-prepend col-md-2 ml-4">
											<div class="input-group-text">
												<input type="checkbox"
													aria-label="Checkbox for following text input">&nbsp;1월
											</div>
										</div>
										<div class="input-group-prepend col-md-2">
											<div class="input-group-text">
												<input type="checkbox"
													aria-label="Checkbox for following text input">&nbsp;2월
											</div>
										</div>
										<div class="input-group-prepend col-md-2">
											<div class="input-group-text">
												<input type="checkbox"
													aria-label="Checkbox for following text input">&nbsp;3월
											</div>
										</div>
										<div class="input-group-prepend col-md-2">
											<div class="input-group-text">
												<input type="checkbox"
													aria-label="Checkbox for following text input">&nbsp;4월
											</div>
										</div>
										<div class="input-group-prepend col-md-2">
											<div class="input-group-text">
												<input type="checkbox"
													aria-label="Checkbox for following text input">&nbsp;5월
											</div>
										</div>
										<div class="input-group-prepend ">
											<div class="input-group-text">
												<input type="checkbox"
													aria-label="Checkbox for following text input">&nbsp;6월
											</div>
										</div>
									</div>
								</td>
						...
						<table class="table table-sm">
							...
							<tbody>
								...
								<tr>
									<th scope="row">2</th>
									<td><a href="/">인증해요</a></td>
									<td class="text-center">2020/11/15</td>
					...
					<td width="810px">
						<table class="table table-sm">
							<thead>
								<tr>
									<th scope="col">#</th>
									<th scope="col" class="col-sm-1 text-center">제목</th>
									<th scope="col" class="text-center">작성일</th>
								</tr>
							</thead>
							<tbody>
